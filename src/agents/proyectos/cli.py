...
from agents.proyectos.acta_graph import run_proyectos_acta_graph
from agents.shared_tools.cli_utils import load_env_file


def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Run the proyectos end-to-end graph.")
...
def main() -> int:
    ...
    result = run_proyectos_acta_graph(
